      ...
      <div className="max-w-md w-full bg-white p-12 shadow-xl border border-gray-100 flex flex-col items-center">
        ...
        <div className="w-full space-y-4">
          <button 
            onClick={onLogin}
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold py-4 px-6 transition-all group"
          >
            {isLoading ? (
               <div className="uber-loader border-gray-300 border-t-gray-600"></div>
            ) : (
               <>
